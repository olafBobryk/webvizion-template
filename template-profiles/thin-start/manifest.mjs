...
export const thinStartProfile = {
	...
	apiReview: {
		allowedUiImports: [
			...
			"@/components/ui/primitives/dropdown/DropdownSurface",
			"@/components/ui/primitives/dropdown/useDropdownCollectionController",
	...
	verification: {
		requiredFiles: [
			...
			"src/components/ui/primitives/dropdown/DropdownCollection.tsx",
			"src/components/ui/primitives/dropdown/useDropdownCollectionController.ts",
		],
		forbiddenPaths: [
