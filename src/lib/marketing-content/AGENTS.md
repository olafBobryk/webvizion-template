...
- Run `npm run verify:marketing` for a complete marketing change. Use `npm run verify:marketing-sections`, `npm run verify:site-layout`, or `npm run verify:marketing-media` only for focused diagnosis.
